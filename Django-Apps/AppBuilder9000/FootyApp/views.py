...
def home(request):
    return render(request, 'FootyApp/footy_home.html')
...
def index(request):
    ...
    return render(request, 'FootyApp/footy_index.html', context)
...
def add_jersey(request):
    ...
    return render(request, 'FootyApp/footy_create.html', {'form':form})
...
def details_jersey(request, pk):
    ...
    return render(request,'FootyApp/footy_details.html', context)
...
def api_response(request):
    ...
    return render(request, 'FootyApp/footy_api.html', context)
...
def matches(request, code):
    ...
    return render(request, 'FootyApp/footy_matches.html', context) #Sends completed dictionary of matches and timezone to template
...
def mls_news(request):
    ...
    return render(request, 'FootyApp/mls_news.html', context)
